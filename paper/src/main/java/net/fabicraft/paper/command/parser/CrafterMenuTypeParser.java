...
public final class CrafterMenuTypeParser<C> implements ArgumentParser<C, MenuType>, BlockingSuggestionProvider.Strings<C> {
	private static final Map<String, MenuType> MENU_TYPE_MAP = Map.ofEntries(
	...
	public static <C> @NonNull ParserDescriptor<C, MenuType> menuTypeParser() {
		return ParserDescriptor.of(new CrafterMenuTypeParser<>(), MenuType.class);
	}

	public static <C> CommandComponent.@NonNull Builder<C, MenuType> menuTypeComponent() {
		return CommandComponent.<C, MenuType>builder().parser(menuTypeParser());
	}
	...
	public static final class MenuTypeParseException extends ParserException {
		private MenuTypeParseException(
				final @NonNull String input,
				final @NonNull CommandContext<?> context
		) {
			super(
					CrafterMenuTypeParser.class,
					context,
					Caption.of("argument.parse.failure.menutype"),
